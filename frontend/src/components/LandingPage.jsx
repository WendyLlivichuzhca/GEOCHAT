  ...
  return (
    <PublicLayout>
      ...
      <section style={{
        ...
        overflow: 'hidden',
        /* Aurora mesh gradient — lavender centered top matching screenshot exactly */
        background: `
          radial-gradient(ellipse 110% 70% at 50% -5%, rgba(195, 210, 255, 0.60) 0%, rgba(180, 200, 255, 0.25) 45%, transparent 70%),
          radial-gradient(ellipse 45% 45% at 85% 40%, rgba(0, 194, 255, 0.09) 0%, transparent 60%),
          radial-gradient(ellipse 35% 35% at 15% 70%, rgba(0, 214, 143, 0.06) 0%, transparent 55%),
          radial-gradient(ellipse 50% 40% at 70% 95%, rgba(167, 139, 250, 0.06) 0%, transparent 60%),
          #FBFEFF
        `,
        minHeight: '100vh',
        paddingTop: '7rem',
        ...
        <div className="hero-grid" style={{
          ...
          {/* ─────────────── RIGHT COLUMN ─────────────── */}
          {/* Layout: [Phone+Badge wrapper] [Stats Column] — matching screenshot exactly */}
          <div className="right-col" style={{
            ...
            {/* ── Phone + Badge wrapper (badge overlaps the phone's left edge) ── */}
            <div style={{ position: 'relative', flexShrink: 0, zIndex: 10 }}>

              {/* ── WhatsApp Badge — absolutely positioned to overlap left side of phone at ~35% from top ── */}
              <div className="float-c" style={{
                ...
                <div style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: '0 16px 40px rgba(37, 211, 102, 0.50), 0 4px 12px rgba(37, 211, 102, 0.20)',
                }}>
