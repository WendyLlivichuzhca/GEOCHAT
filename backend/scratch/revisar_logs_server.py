...
# También buscar en la carpeta principal
out_log = "/home/geosis/.pm2/logs/geochat-backend-out.log"
err_log = "/home/geosis/.pm2/logs/geochat-backend-error.log"
for log_path in [out_log, err_log]:
    if os.path.exists(log_path):
        print(f"\n--- ÚLTIMAS 40 LÍNEAS DE LOG PM2: {os.path.basename(log_path)} ---")
        try:
            with open(log_path, 'r', encoding='utf-8', errors='ignore') as f:
                lines = f.readlines()
                for line in lines[-40:]:
