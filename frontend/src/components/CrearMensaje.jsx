      ...
      return (
        <>
          ...
          >
            ...
            <p className="mt-4 text-[15px] text-slate-500">Haz clic para cargar</p>
            <p className="mt-2 text-xs text-slate-400">Imagen max. 8MB • Video max. 80MB</p>
        ...
        <>
          ...
          <div className="mt-5">
            ...
            <div className="mt-4 flex flex-col gap-3 text-xs text-slate-400 lg:flex-row lg:items-center lg:justify-between">
              <span>Mínimo 2 opciones o Máximo 12 opciones</span>
              <button
                type="button"
                onClick={() =>
                  updateBlock(block.id, () => ({
  ...
  return (
    <div className="flex min-h-screen bg-transparent font-sans selection:bg-emerald-200/50">
      ...
      <main className="ml-20 flex-1 h-screen flex flex-col min-w-0 overflow-hidden">
        <Header user={user} onLogout={onLogout} title="GeoChat" onRefresh={loadScheduledOptions} isLoading={optionsLoading} />
