...
const GruposComunidades = ({ user, onLogout }) => {
  ...
  return (
    <div className="flex h-screen bg-[#eef3f8] font-sans text-slate-900 overflow-hidden">
      ...
      <main className="ml-28 mr-5 mt-2 mb-2 flex h-[calc(100vh-16px)] flex-1 flex-col overflow-hidden rounded-[2rem] bg-white shadow-[0_20px_70px_rgba(15,23,42,0.06)] lg:ml-32">
