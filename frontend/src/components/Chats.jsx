                    ...
                    <div className="p-6 space-y-6">
                      ...
                      <div className="pt-4 border-t border-slate-100 flex gap-3">
                        <button
                          ...
                          className="flex-1 py-2.5 text-xs font-bold text-slate-500 bg-slate-50 hover:bg-slate-100 rounded-xl transition-all"
                        >
                          Limpiar
                        </button>
                        <button
                          ...
                          className="flex-1 py-2.5 text-xs font-bold text-white bg-emerald-500 hover:bg-emerald-600 rounded-xl transition-all shadow-sm"
                        >
                          Aplicar
                        </button>
                      </div>
